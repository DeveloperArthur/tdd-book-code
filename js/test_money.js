...
class MoneyTest {
    ...
    testAdditionOfDollarsAndWons(){
        ...
        assert.deepStrictEqual(portfolio.evaluate("KRW"),
            expectedValue);
    }
    testAdditionWithMultipleMissingExchangeRates(){
        ...
        assert.throws(function() {portfolio.evaluate("Kalganid")},
            expectedError);
    }
    runAllTests(){
        ...
        testMethods.forEach(m => {
            ...
            try {
                ...
                if(e instanceof assert.AssertionError){ console.log(e);}
                else { throw e; }
            }
        });
    } 
